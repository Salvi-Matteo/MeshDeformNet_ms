...
#MR TRAIN
subprocess.call([  
    "python", "data/data2tfrecords.py", "--folder" ,"/content/drive/MyDrive/Dataset/mr_train",
    "--modality", "mr",
...
#MR VAL
subprocess.call([  
    "python", "data/data2tfrecords.py", "--folder" ,"/content/drive/MyDrive/Dataset/mr_val",
    "--modality", "mr",
    "--size" ,"128" ,"128", "128" , # image dimension for training
...
#CT TRAIN
subprocess.call([  
    "python", "data/data2tfrecords.py", "--folder" ,"/content/drive/MyDrive/Dataset/ct_train",
    "--modality", "ct",
    "--size" ,"128" ,"128", "128" , # image dimension for training
    "--folder_postfix" ,"_train", # _train or _val, i.e. will process the images/segmentation in ct_train and ct_train_seg
    "--deci_rate" ,"0" , # decimation rate on ground truth surface meshes
